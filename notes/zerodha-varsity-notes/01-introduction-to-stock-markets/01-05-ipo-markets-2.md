...
[Chapter link](https://zerodha.com/varsity/chapter/the-ipo-markets-part-2/)

> #### 📌 Terminology
> - **BRLM/LM** — Book Running Lead Manager/Lead Manager - The merchant banker
> - **Primary Market** —  During the bidding process, investors can bid for shares at a particular price within the specified price band.  This whole system is referred to as the Primary Market around the date of the issue where one bids for shares.
> - **Secondary Market** —  The moment the stock gets listed and debuts on the stock exchange, the stock starts to trade publicly. This is called the secondary market.
...
3. The promoter can spread the risk amongst a large group of investors instead of one large investor. 100s and 1000s of retail investors are better than one large private equity investor.
4. Provide an exit for early investors – Once the company goes public, the shares of the company start trading publicly. Any existing company shareholders– promoters, angel investors, venture capitalists, or PE funds; can use this opportunity to sell their shares in the open market. By selling their shares, they get an exit on their initial investment in the company. Of course, there is a lock-in period before which early investors cant exit, but that is beside the point.
5. Reward employees –Employees, working for the company would have shares allotted to them as an incentive. This arrangement between the employee and the company is called the “Employee Stock Option” or ESOPS. The shares are allotted at a discount to the employees. Once the company goes public, the employees can see capital appreciation in the shares. A few examples where the employee benefited from ESOP would be Google, Infosys, Twitter, Facebook, Amazon, etc
6. Improve visibility – Going public increases visibility as the company is publicly held and traded. There is a greater chance of people’s interest in the company, consequently impacting its growth.

## IPO Process — Role of Merchant Bankers (BRLM/LM)

 - **First step:** Once a company decides to go public, it appoints a **Merchant Banker**, also known as a **Book Running Lead Manager (BRLM) / Lead Manager (LM)**.
- **Due diligence:** Conducts due diligence, checks legal/regulatory compliance, and issues a **due diligence certificate**.
- **IPO documents:** Works with the company to prepare listing documents, including the **Draft Red Herring Prospectus (DRHP)**.
- **Underwriting:** Agrees to subscribe to the **unsubscribed portion of fresh shares**, subject to the applicable threshold. If subscription falls below the required threshold, the IPO **fails** and investor funds are unblocked.
- **Price band:** Helps determine the **IPO price band**, i.e., the lower and upper limits within which shares are offered.
- **Roadshows:** Helps conduct **roadshows**, which promote the IPO to potential investors.
- **Other intermediaries:** Appoints/co-ordinates intermediaries such as **registrars, bankers, and advertising agencies** and develops marketing strategies for the issue.

 **In short:** The merchant banker/BRLM acts as the **key coordinator of the IPO**, helping the company with compliance, documentation, pricing, underwriting, marketing, and appointment of intermediaries.
